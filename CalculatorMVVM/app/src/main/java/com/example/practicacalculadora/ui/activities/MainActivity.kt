...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupEventListeners() {
        ...
        binding.btnEquals.setOnClickListener { viewModel.solveOperation() }
        ...
        binding.btnMC.setOnClickListener { viewModel.memoryClear() }
        binding.btnMR.setOnClickListener { viewModel.memoryRecall() }
        binding.btnMPlus.setOnClickListener { viewModel.memoryAdd() }
        binding.btnMMinus.setOnClickListener { viewModel.memorySubtract() }
    }
}